...
export function Pricing() {
  return (
    // <div className="relative isolate bg-gradient-to-b from-black via-gray-900 to-black px-6 py-24 sm:py-32 lg:px-8">
    <div className="relative isolate bg-black px-6 py-18 sm:py-32 lg:px-8">
      ...
      <p className="mx-auto mt-6 max-w-2xl text-center text-lg font-medium text-gray-300 sm:text-xl">Choose an affordable plan that’s packed with the best features for engaging your audience, creating customer loyalty, and driving sales.</p>
      <div className="mx-auto mt-16 grid max-w-lg grid-cols-1 items-center gap-y-6 sm:mt-20 sm:gap-y-0 lg:max-w-4xl lg:grid-cols-2">
        <div className="relative rounded-3xl bg-white p-8 ring-1 ring-gray-900/10 sm:mx-8 sm:p-10 lg:mx-0 lg:rounded-bl-3xl lg:rounded-tr-none transition-opacity duration-500 opacity-0 animate-fade-in">
          ...
          <p className="mt-6 text-black text-black">The perfect plan if you're just getting started with our product.</p>
